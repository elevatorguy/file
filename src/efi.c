...
EFI_STATUS test_graphics(void) {
    ...
    EFI_GUID device = INTEL_HD_GRAPHICS_530_GUID;
    EFI_GUID device_subsystem = INTEL_HD_GRAPHICS_530_SUBSYSTEM_GUID;

    //todo - find documentation of INTEL_HD_GRAPHICS_530_PROTOCOL(s)
