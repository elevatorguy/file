...
#define SCANCODE_DELETE     0x8
#define SCANCODE_F8         0x12
...
const CHAR16 *EFI_ERROR_STRINGS[MAX_EFI_ERROR] = {
    [2]  = u"EFI_INVALID_PARAMETER",
    [3]  = u"EFI_UNSUPPORTED",
    [5]  = u"EFI_BUFFER_TOO_SMALL",
	[6]  = u"EFI_NOT_READY",
    [7]  = u"EFI_DEVICE_ERROR",
    [9]  = u"EFI_OUT_OF_RESOURCES",
    [14] = u"EFI_NOT_FOUND",
    [15] = u"EFI_ACCESS_DENIED",
    [19] = u"EFI_NOT_STARTED",
    [20] = u"EFI_ALREADY_STARTED",
    [27] = u"EFI_CRC_ERROR",
};
...
typedef struct EFI_DHCP4_PROTOCOL EFI_DHCP4_PROTOCOL;
...
typedef struct EFI_DHCP4_PROTOCOL {
